    ...
    public function init_form_fields() {
        ...
        $this->form_fields = array(
            ...
            'eh_stripe_apple_pay_language' => array(
                ...
                'description' => sprintf(__( '<span class="eh-desp-class"> Input language code for Apple Pay button text. Defaulted to ‘en’.</span>', 'payment-gateway-stripe-and-woocommerce-integration' )),
                'type'        => 'text',
                'default'     => 'en',
